  ...
  customer: {
    ...
    table: {
      ...
      formFields: [
        ...
        { name: "addressNumber", header: "Address N" },
        { name: "cap", header: "CAP" },
        { name: "phone", header: "Phone" },
        { name: "vat", header: "VAT-ID" },
        { name: "contactPerson", header: "Contact Person" },
        { name: "contactPersonEmail", header: "Contact Person eMail" },
        { name: "contactPersonPhone", header: "Contact Person Phone" },
      ],
    },
  },
  lead: {
